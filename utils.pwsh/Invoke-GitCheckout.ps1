...
function Invoke-GitCheckout {
    <#
        ...
        .EXAMPLE
            Invoke-GitCheckout -Uri "My-Repo-Url" -Commit "My-Commit-Hash"
            Invoke-GitCheckout -Uri "My-Repo-Url" -Commit "My-Commit-Hash" -Branch "main"
            Invoke-GitCheckout -Uri "My-Repo-Url" -Commit "My-Commit-Hash" -PullRequest 250
    #>
    ...
    if ( ! ( $Uri -like "*github.com*" ) -and ( $PullRequest -ne "" ) ) {
        throw "Fetching pull requests only supported with GitHub-based repositories"
    }
