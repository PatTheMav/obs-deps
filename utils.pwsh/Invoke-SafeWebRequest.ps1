function Invoke-SafeWebRequest {
    <#
        ...
        .EXAMPLE
            Invoke-SafeWebRequest -Uri "My-Url" -HashFile "Path-To-HashFile"
            Invoke-SafeWebRequest -Uri "My-Url" -HashFile "Path-To-HashFile" -Resume
            Invoke-SafeWebRequest -Uri "My-Url" -HashFile "Path-To-HashFile" -OutFile "Name-Assumed-By-HashFile"
    #>
    ...
    if ( $Resume.isPresent -and $PSVersionTable.PSVersion -lt "6.1.0") {
    ...
    try {
        ...
        if ( ( $CheckExisting.IsPresent ) -and ( Test-Path $OutFile ) ) {
