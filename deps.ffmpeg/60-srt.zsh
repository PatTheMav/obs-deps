...
local -A hashes=(
  macos ${0:a:h}/checksums/v1.4.4.tar.gz.sha256
  linux ${0:a:h}/checksums/v1.4.4.tar.gz.sha256
  windows 3d26644e2b029b7da94713e1fd16e77006acc715
)
local -a patches=(
  ...
  case ${target} {
    windows-x*)
      args+=(
        ...
        -DCMAKE_SHARED_LINKER_FLAGS="-static-libgcc -static-libstdc++ -Wl,-Bstatic -pthread"
      )
